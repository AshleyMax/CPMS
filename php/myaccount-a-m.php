    ...
    <box>
        ...
        <container2>
            ...
            <container2>
                ...
                <form-container>
                    <form action="../server/modify-author.php" method = "post" name="author-modify">
                        <label for="fname">First name: &ensp;&emsp;&emsp;</label>
                        <input type="text" id="FirstName" name="AMFirstName"><br><br>

                        <label for="midinit">Middle Initial: &nbsp;&emsp;</label>
                        <input type="text" id="MiddleInitial" name="AMMiddleInitial"><br><br>

                        <label for="lname">Last name:&nbsp;&ensp;&emsp;&emsp;</label>
                        <input type="text" id="LastName" name="AMLastName"><br><br>

                        <label for="Afflication">Affliation:&emsp;&emsp;&emsp;</label>
                        <input type="text" id="Affliation" name="AMAffiliation"><br><br>

                        <label for="Department">Department:  &nbsp;&nbsp;&ensp;&emsp;</label>
                        <input type="text" id="Dept" name="AMDepartment"><br><br>

                        <label for="Address">Address: &emsp;&emsp;&emsp;&nbsp;&nbsp;</label>
                        <input type="text" id="Address" name="AMAddress"><br><br>

                        <label for="City">City:  &nbsp;&ensp;&emsp;&emsp;&emsp;&emsp;&nbsp;</label>
                        <input type="text" id="City" name="AMCity"><br><br>

                        <label for="State">State: &nbsp;&emsp;&emsp;&emsp;&emsp;&ensp;</label>
                        <input type="text" id="State" name="AMState"><br><br>

                        <label for="Zipcode">Zipcode:  &ensp;&ensp;&emsp;&emsp;&ensp;</label>
                        <input type="text" id="ZipCode" name="AMZipCode"><br><br>

                        <label for="Email">Email: &nbsp;&emsp;&emsp;&emsp;&emsp;</label>
                        <input type="text" id="EmailAddress" name="AMEmailAddress"><br><br>

                        <input type="submit" class="save-button" value="Save Changes" style="margin-left: 0px" name="modify-author"><br /><br />
                    </form>
                </form-container>
